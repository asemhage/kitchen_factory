...
- `kitchen_factory/app.py` (السطور 3350-3805، 3718-4188، 4070-4188، 6100-6400): دعم اختيار حجم الورقة (A4/A5)، عرض مربعات تحديد لطريقة الدفع، إجبار تحديث الصفحة بعد إضافة دفعة، وتخزين الإعداد من أدوات المشرف.
